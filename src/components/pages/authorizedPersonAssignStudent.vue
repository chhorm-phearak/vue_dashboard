<template>
  <MainApp>
    <div class="grid grid-cols-1 mb-4">
      ...
      >
        <h5 class="text-xl font-bold tracking-tight text-gray-900">
          Authorized Person Assign Student
        </h5>
    ...
    <ModalAuthorizedPersonAssignStudent
      v-model:modelValue="showModal"
      @close="handleClose"
    />
    <TableAuthorizedPersonAssignStudent />
  </MainApp>
</template>
...
import ModalAuthorizedPersonAssignStudent from "@/components/modals/modalAuthorizedPerson.vue";
import TableAuthorizedPersonAssignStudent from "@/components/tables/tableAuthorizedPerson.vue";
