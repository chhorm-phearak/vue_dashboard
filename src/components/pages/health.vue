<template>
  <MainApp>
    <div class="grid grid-cols-1 mb-4">
      ...
      >
        <h5 class="text-xl font-bold tracking-tight text-gray-900">Health</h5>
    ...
    <ModalHealth v-model:modelValue="showModal" @close="handleClose" />
    <TableHealth />
  </MainApp>
</template>
...
import ModalHealth from "@/components/modals/modalHealth.vue";
import TableHealth from "@/components/tables/tableHealth.vue";
