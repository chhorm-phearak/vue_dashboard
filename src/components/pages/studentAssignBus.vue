<template>
  <MainApp>
    ...
    <ModalStudentAssignBus
      v-model:modelValue="showModal"
      @close="handleClose"
    />
    <TableStudentAssignBus />
  </MainApp>
</template>
...
import ModalStudentAssignBus from "@/components/modals/modalStudentAssignBus.vue";
import TableStudentAssignBus from "@/components/tables/tableStudentAssignBus.vue";
