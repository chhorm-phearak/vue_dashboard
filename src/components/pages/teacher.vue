<template>
  <MainApp>
    <div class="grid grid-cols-1 mb-4">
      ...
      >
        <h5 class="text-xl font-bold tracking-tight text-gray-900">Teacher</h5>
    ...
    <ModalTeacher v-model:modelValue="showModal" @close="handleClose" />
    <TableTeacher />
  </MainApp>
</template>
...
import ModalTeacher from "@/components/modals/modalTeacher.vue";
import TableTeacher from "@/components/tables/tableTeacher.vue";
