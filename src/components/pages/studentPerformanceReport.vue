<template>
  <MainApp>
    ...
    <ModalStudentPerformanceReport
      v-model:modelValue="showModal"
      @close="handleClose"
    />
    <TableStudentPerformanceReport />
  </MainApp>
</template>
...
import ModalStudentPerformanceReport from "@/components/modals/modalStudentPerformanceReport.vue";
import TableStudentPerformanceReport from "@/components/tables/tableStudentPerformanceReport.vue";
