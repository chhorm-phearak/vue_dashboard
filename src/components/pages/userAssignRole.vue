<template>
  <MainApp>
    ...
    <ModalUserAssignRole v-model:modelValue="showModal" @close="handleClose" />
    <TableUserAssignRole />
  </MainApp>
</template>
...
import ModalUserAssignRole from "@/components/modals/modalUserAssignRole.vue";
import TableUserAssignRole from "@/components/tables/tableUserAssignRole.vue";
