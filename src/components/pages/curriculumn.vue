<template>
  <MainApp>
    <div class="grid grid-cols-1 mb-4">
      ...
      >
        <h5 class="text-xl font-bold tracking-tight text-gray-900">Curriculumn</h5>
    ...
    <ModalCurriculumn v-model:modelValue="showModal" @close="handleClose" />
    <TableCurriculumn />
  </MainApp>
</template>
...
import ModalCurriculumn from "@/components/modals/modalCurriculumn.vue";
import TableCurriculumn from "@/components/tables/tableCurriculumn.vue";
